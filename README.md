...
Docusign - JavaScript client for docusign-test4
...
```shell
npm install docusign-test4 --save
```
...
Finally, switch to the directory you want to use your docusign-test4 from, and run:

```shell
npm link /path/to/<JAVASCRIPT_CLIENT_DIR>
```

You should now be able to `require('docusign-test4')` in javascript files from the directory you ran the last 
command above from.
...
```javascript
var Docusign = require('docusign-test4');
